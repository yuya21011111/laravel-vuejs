                                ...
                                <div class="lg:w-1/2 md:w-2/3 mx-auto">
                                    <div class="flex flex-wrap -m-2">
                                        ...
                                        <div class="p-2  w-full">
                                            ...
                                            <div class="text-xl text-red-500" v-if="errors.is_selling">{{ errors.is_selling }}</div>
                                        </div>
                                        ...
                                        <div class="p-2 w-full">
                                            <button
                                                class="flex mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">顧客登録ß</button>
                                        </div>  
                                </div>
                            </div>
                        </div>
