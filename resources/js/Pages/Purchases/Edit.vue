                                        ...
                                        <div class="flex flex-wrap -m-2">
                                                ...
                                                <table class="table-auto w-full text-left whitespace-no-wrap">
                                                    ...
                                                    <tbody>
                                                        <tr v-for="item in itemList" :key="item.id">
                                                            ...
                                                            <td class="border-b-2 border-gray-200 px-4 py-3">{{ item.price * item.quantity }}
                                                            </td>
                                                        </tr>
                                            ...
                                            <div class="p-2  w-full">
                                                <div class="relative">
                                                    ...
                                                    <input  type="radio" id="status" v-model="form.status" name="status" value="0">未キャンセル
                                                    <input  type="radio" id="status" v-model="form.status" name="status" value="1">キャンセル
                                                </div>
                                            </div>
